"""
Django settings for mobilemart project.
...
SECRET_KEY = 'django-insecure-=5ux*lc^#konp8e2@c77t#9jl36hu#!98qt35ucl*ude15+65s'
...
WSGI_APPLICATION = 'mobilemart.wsgi.application'
